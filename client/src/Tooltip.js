...
class Tooltip extends SampleBase {
    ...
    componentDidMount = () => {
      console.log("imp tooltip : ", this.props.scheduleData);
      // this.schedules = this.props.scheduleData;
    ...
    constructor() {
        ...
        // this.state = {
        //   schedules: this.props.scheduleData,
        //   done: true
        // };
        // this.schedules = this.props.scheduleData;
    }
    ...
    handleInsert(id, subject, startTime, endTime, eventType){
      let x_color;
    ...
    handleEdit = (id, subject, startTime, endTime, eventType) => {
      let x_color;
      if(eventType == "In-Progress"){
        x_color = "#008B8B";
      } else if(eventType == "Completed"){
    ...
    solve(event, status) {
      ...
      if(status == "insert"){
        this.handleInsert(x_id, x_subject, x_start_time, x_end_time, x_event_type);
      } else if(status == "edit"){
        this.handleEdit(x_id, x_subject, x_start_time, x_end_time, x_event_type);
      } else if(status == "delete"){
        this.handleDelete(x_id);
      }
      // console.log("id : ", x_id);
    ...
    onActionBegin(args) {
      ...
      this.solve(args.addedRecords, "insert");
      // edit
      console.log("edit : ", args.changedRecords);
      this.solve(args.changedRecords, "edit");
      // delete 
      console.log("delete : ", args.deletedRecords);
      this.solve(args.deletedRecords, "delete");
    }
    ...
    render() {
        ...
        console.log("result result : ", this.props.scheduleData);
        ...
        <div className='col-lg-12 control-section'>
          <div className='control-wrapper'>
            {/* <ScheduleComponent width='100%' height='650px' selectedDate={new Date(2018, 1, 15)} ref={t => this.scheduleObj = t} eventSettings={{
              ...
              // actionEventArgs={this.solve.bind(this)} 
            ...
            <ScheduleComponent width='100%' height='650px' selectedDate={new Date(2018, 1, 15)} ref={t => this.scheduleObj = t} eventSettings={{
              ...
              // actionEventArgs={this.solve.bind(this)} 
              eventRendered={this.onEventRendered.bind(this)}
              eventSettings={{ dataSource: this.props.scheduleData }}
